...
import './App.css';
import styles from './ig-style.module.css';
...
class storiesLeftButton extends React.Component {
    render(): React.ReactNode {
        return (<button>Stories Left</button>)
    }
}
class storiesRightButton extends React.Component {
    render(): React.ReactNode {
        return (<button>Stories Right</button>)
    }
}
    ...
    render(): React.ReactNode {
        return (
          <div className={`styles.stories`}>
            <button className={`styles.stories__left-button`}>
            ...
            <div className={`styles.stories__content`}>
              <button className={`styles.story story--has-story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                    <svg
                      width="64"
                      height="64"
                  ...
                  <div className={`styles.story__picture`}>
                    <img src="assets/default-user.png" alt="User Picture" />
                  </div>
                </div>
                <span className={`styles.story__user`}>usernick1</span>
              </button>
              <button className={`styles.story story--has-story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick2</span>
              </button>
              <button className={`styles.story story--has-story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick3</span>
              </button>
              <button className={`styles.story`}>
                ...
                <span className={`styles.story__user`}>usernick4</span>
              </button>
              <button className={`styles.story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick5</span>
              </button>
              <button className={`styles.story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick6</span>
              </button>
              <button className={`styles.story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick7</span>
              </button>
              <button className={`styles.story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick8</span>
              </button>
              <button className={`styles.story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick9</span>
              </button>
              <button className={`styles.story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick10</span>
              </button>
              <button className={`styles.story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick11</span>
              </button>
              <button className={`styles.story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick12</span>
              </button>
              <button className={`styles.story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick13</span>
              </button>
              <button className={`styles.story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick14</span>
              </button>
              <button className={`styles.story`}>
                <div className={`styles.story__avatar`}>
                  <div className={`styles.story__border`}>
                ...
                <span className={`styles.story__user`}>usernick15</span>
              </button>
            </div>
            <button className={`styles.stories__right-button`}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
                  fill="#fff"
            ...
            <article className={styles.post}>
                <div className={styles.post__header}>
                    <div className={styles.post__profile}>
                        <a href='#' className={styles.post__avatar}>
                            <img src="assets/default-user.png" alt="User Picture" />
                        </a>
                        <a href='#' className={styles.post__user}>Username{i}</a>
                    </div>
                    <button className={`styles.post__more-options`}>
                ...
                <div className={styles.post__content}>
                    <div className={styles.post__medias}>
                        <img src="assets/insta-clone.png" />
                    </div>
                </div>
                ...
                <div className={styles.post__footer}>
                    <div className={styles.post__buttons}>
                        ...
                        <div className={styles.post__indicators} />

                        <button className={`styles.post__button styles.post__button--align-right`}>
                            <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                    ...
                    <div className={styles.post__infos}>
                        <div className={styles.post__likes}>
                            <a href="#" className={`styles.post__likes-avatar`}>
                            <img src="assets/default-user.png" alt="User Picture" />
                            </a>

                            <span
                            >Liked by
                            <a className={`styles.post__name--underline`} href="#">user123</a> and
                        ...
                        <div className={styles.post__description}>
                            <span>
                            <a
                                className={`styles.post__name--underline`}
                        ...
                        <span className={`styles.post__date-time`}>30 minutes ago</span>
                    </div>
                </div>
            </article>)
        };
        ...
        return (
            <header className={`styles.header`}>
                <nav className={`styles.header__content`}>
                    ...
                    <a href="index.html" className={`styles.header__home`}>
                        <svg
                        width="104"
                        height="30"
                        viewBox="0 0 104 30"
                    ...
                    <button className={`styles.header__theme-button`} title="Toggle Theme">
                        ...
                        <svg
                        className={`styles.header__theme-button-sun`}
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        fill="var(--text-dark)"
                    ...
                    <section className={`styles.side-menu`}>
                        <div className={`styles.side-menu__user-profile`}>
                            <a
                                href="https://github.com/leocosta1"
                                target="_blank"
                                className={'styles.side-menu__user-avatar'}
                            > <img src="assets/default-user.png" alt="User Picture" /> </a>
                            <div className={`styles.side-menu__user-info`}>
                                <a href="https://github.com/leocosta1" target="_blank">leocosta1</a >
                                <span>Leonardo Costa</span>
                            </div>
                            <button className={`styles.side-menu__user-button`}>Switch</button>
                        </div>
                        <div className={`styles.side-menu__suggestions-section`}>
                            <div className={`styles.side-menu__suggestions-header`}>
                            <h2>Suggestions for You</h2>
                            <button>See All</button>
                            </div>
                            <div className={`styles.side-menu__suggestions-content`}>
                            <div className={`styles.side-menu__suggestion`}>
                                <a href="#" className={`side-menu__suggestion-avatar`}>
                                <img src="assets/default-user.png" alt="User Picture" />
                                </a>
                                <div className={`styles.side-menu__suggestion-info`}>
                                <a href="#">usernick16</a>
                                <span>Followed by user1, user2 and 9 others</span>
                                </div>
                                <button className={`styles.side-menu__suggestion-button`}>Follow</button>
                            </div>
                            <div className={`styles.side-menu__suggestion`}>
                                <a href="#" className={`styles.side-menu__suggestion-avatar`}>
                                <img src="assets/default-user.png" alt="User Picture" />
                                </a>
                                <div className={`styles.side-menu__suggestion-info`}>
                                <a href="#">usernick17</a>
                        ...
                        <div className={`styles.side-menu__footer`}>
                            <div className={`styles.side-menu__footer-links`}>
                            <ul className={`styles.side-menu__footer-list`}>
                                <li className={`styles.side-menu__footer-item`}>
                                <a className={`styles.side-menu__footer-link`} href="#">About</a>
                                </li>
                                <li className={`styles.side-menu__footer-item`}>
                                <a className={`styles.side-menu__footer-link` } href="#">Help</a>
                                </li>
                                <li className={`styles.side-menu__footer-item`}>
                                <a className={`styles.side-menu__footer-link` } href="#">Press</a>
                                </li>
                                <li className={`styles.side-menu__footer-item`}>
                                <a className={`styles.side-menu__footer-link` } href="#">API</a>
                                </li>
                                <li className={`styles.side-menu__footer-item`}>
                                <a className={`styles.side-menu__footer-link` } href="#">Jobs</a>
                                </li>
                                <li className={`styles.side-menu__footer-item`}>
                                <a className={`styles.side-menu__footer-link` } href="#">Privacy</a>
                                </li>
                                <li className={`styles.side-menu__footer-item`}>
                                <a className={`styles.side-menu__footer-link` } href="#">Terms</a>
                                </li>
                                <li className={`styles.side-menu__footer-item`}>
                                <a className={`styles.side-menu__footer-link` } href="#">Locations</a>
                                </li>
                                <li className={`styles.side-menu__footer-item`}>
                                <a className={`styles.side-menu__footer-link` } href="#">Top Accounts</a>
                                </li>
                                <li className={`styles.side-menu__footer-item`}>
                                <a className={`styles.side-menu__footer-link` } href="#">Hashtag</a>
                                </li>
                                <li className={`styles.side-menu__footer-item`}>
                                <a className={`styles.side-menu__footer-link` } href="#">Language</a>
                                </li>
                            </ul>
                            </div>
