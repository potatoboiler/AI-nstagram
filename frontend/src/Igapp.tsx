        ...
        return (
          <div className={`styles.stories`}>
            ...
            <div className={`styles.stories__content`}>
              <button className={`styles.story styles.story--has-story`}>
                <div className={`styles.story__avatar`}>
                  ...
                  <div className={`styles.story__picture`}>
                    <img src="assets/default-user.png" alt="meaningful text" />
                  </div>
                </div>
...
class Posts extends React.Component {
    render(): React.ReactNode {
        ...
        for (var i = 0; i < num_posts; i++) {
            posts_List.push(
            <article className={styles.post} key={'post__' + i}>
        ...
        return (
                    <section className={`styles.side-menu`}>
                        <div className={`styles.side-menu__user-profile`}>
                            ...
                            > <img src="assets/default-user.png" alt="meaningful text" /> </a>
