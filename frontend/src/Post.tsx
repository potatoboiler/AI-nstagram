...
const Post = () => {
  const [data, setData] = useState<Array<Base64>>([]);
    ...
    <article className="post">
      <div className="post__header">
        <div className="post__profile">
          ...
          <a href="#" target="_blank" className="post__user">
            {username}
          </a>
        </div>
      ...
      <div className="post__footer">
        ...
        <div className="post__infos">
          <div className="post__likes">
            ...
            <span>
              ...
              <a className="post__name--underline" href="#">
                {" "}
                {generateCaption(Math.floor(Math.random() * 32))}
              </a>{" "}
              and
              <a href="#"> {Math.floor(Math.random() * 100)} others</a>
            </span>
          </div>

          <div className="post__description">
            <span>
              <a className="post__name--underline" href="#" target="_blank">
                {username}{" "}
              </a>
              {generateCaption(100)}
            </span>
          ...
          <span className="post__date-time">
