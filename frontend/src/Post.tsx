...
class PostButtons extends React.Component<{ data: Base64[] }> {
  ...
  componentDidUpdate(prevProps: Readonly<{ data: Base64[]; }>, prevState: Readonly<{}>, snapshot?: any): void {
    console.log('update', this.props.data.length);
  }
  render(): React.ReactNode {
    if (this.props.data.length > 1) {
      const leftButtonElement = <button className="post__left-button" ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"> <path fill="#fff" d="M256 504C119 504 8 393 8 256S119 8 256 8s248 111 248 248-111 248-248 248zM142.1 273l135.5 135.5c9.4 9.4 24.6 9.4 33.9 0l17-17c9.4-9.4 9.4-24.6 0-33.9L226.9 256l101.6-101.6c9.4-9.4 9.4-24.6 0-33.9l-17-17c-9.4-9.4-24.6-9.4-33.9 0L142.1 239c-9.4 9.4-9.4 24.6 0 34z"></path> </svg></button>;
      const rightButtonElement = <button className="post__right-button"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"> <path fill="#fff" d="M256 8c137 0 248 111 248 248S393 504 256 504 8 393 8 256 119 8 256 8zm113.9 231L234.4 103.5c-9.4-9.4-24.6-9.4-33.9 0l-17 17c-9.4 9.4-9.4 24.6 0 33.9L285.1 256 183.5 357.6c-9.4 9.4-9.4 24.6 0 33.9l17 17c9.4 9.4 24.6 9.4 33.9 0L369.9 273c9.4-9.4 9.4-24.6 0-34z"></path> </svg> </button>;
      ...
      return (
        <>ad sofijasdofi jasdofi jasodfi jasodfi jad</>
      );
    }
  }
}
...
class PostContent extends React.Component<{ data: Base64[] }> { 
  render(): React.ReactNode {
      var medias: Array<JSX.Element> = this.props.data.map((data) => {return <PostMedia data={data} />});
      return (
            ...
            <article className="post">
              ...
              <div className="post__footer">
                ...
                <div className="post__infos">
                  ...
                  <span className="post__date-time">{Math.floor(Math.random() * 60)} minutes ago</span>
                </div>
              </div>
            </article>
        )
